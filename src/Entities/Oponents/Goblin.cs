...
{
    public class Goblin : Oponent
    {
        
        public Goblin(string Name, int Level , string Breed, int AttackPoints,int DefPoints,int HealtPoints, int ManaPoints) 
            ...
            public string Attack(int Damage)
        {
            ...
            {
                return this.Name + " Atacou com suas garras e deu um dano de  "+ Damage;
            }
    }
}
}